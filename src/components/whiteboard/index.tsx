...
export default function RoomCanvas({ courseId, topic }: { courseId: string; topic: string }) {
...
function Canvas({ topic }: { topic: string }) {
  ...
  return (
    ...
    <div className="w-full h-screen flex flex-col items-start justify-start">
      ...
      {/* Middle Bar */}
      <div className="w-full flex items-center h-full gap-x-8 py-4">
        <TooltipProvider>
          {/* Left Side - BoardOptions */}
          ...
          <div className="flex-1 relative h-full">
            <div className={`${styles.canvas} w-full h-full`}>
              <SelectionTools
                isAnimated={
